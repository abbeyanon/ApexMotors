    ...
    <section className="py-16 sm:py-20 bg-dark-950">
      <div className="max-w-[1550px] mx-auto px-3 sm:px-5 lg:px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-12">
          ...
          <button
            ...
            className="self-start md:self-auto px-4 py-2.5 rounded-xl bg-dark-850 hover:bg-dark-800 border border-slate-700 text-slate-200 hover:text-white text-xs font-semibold flex items-center gap-2 transition"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {reviews.slice(0, 4).map((rev) => (
            <div
              key={rev.id}
              className="bg-dark-900 border border-slate-800 rounded-2xl p-6 flex flex-col justify-between hover:border-slate-700 transition-all duration-300"
            >
              <div>
              ...
              <div className="pt-4 border-t border-slate-800/80 flex items-center gap-3">
                {rev.avatar ? (
                  ...
                  <div className="w-10 h-10 rounded-full bg-brand-900/60 border border-brand-500/30 flex items-center justify-center font-bold text-brand-400 text-xs">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-brand-400 font-medium truncate max-w-[170px] mt-0.5">
      ...
      {isWriteModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-dark-950/80 backdrop-blur-md animate-in fade-in">
          <div className="bg-dark-900 border border-slate-800 rounded-3xl max-w-md w-full p-6 sm:p-8 shadow-2xl relative">
            <button
            ...
            <h3 className="text-xl font-bold text-white mb-1">Share Your Experience</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-xs">
              <div>
                <label className="block text-slate-300 font-semibold mb-1 uppercase tracking-wider">Your Name *</label>
                <input
                  type="text"
                  required
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-slate-300 font-semibold mb-1 uppercase tracking-wider">City / Location</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-slate-300 font-semibold mb-1 uppercase tracking-wider">Car Model Purchased</label>
                  <input
                    type="text"
              ...
              <div>
                <label className="block text-slate-300 font-semibold mb-1 uppercase tracking-wider">Rating (1 to 5 Stars)</label>
              ...
              <div>
                <label className="block text-slate-300 font-semibold mb-1 uppercase tracking-wider">Your Review *</label>
                <textarea
                  rows={3}
                  required
