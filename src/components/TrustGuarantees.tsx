...
export const TrustGuarantees: React.FC = () => {
  ...
  return (
    <section className="py-16 sm:py-20 bg-dark-900 border-y border-slate-800 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {guarantees.map((item, idx) => {
            ...
            return (
              <div
                key={idx}
                className="bg-dark-950/80 border border-slate-800 hover:border-slate-700 p-6 sm:p-7 rounded-2xl transition-all duration-300 hover:shadow-card group"
              >
                <div className="w-12 h-12 rounded-xl bg-brand-500/10 border border-brand-500/20 text-brand-400 flex items-center justify-center mb-5 group-hover:scale-110 group-hover:bg-brand-500 group-hover:text-white transition-all duration-300">
